...
You have access to a fully-featured OpenShift cluster with **Red Hat OpenShift AI (RHOAI)**, an OpenShift add-on that comes with a number of tools for building, running, and managing AI workloads.

This OpenShift cluster instance is shared among all participants in this lab. Each participant has dedicated projects/namespaces in this cluster.
