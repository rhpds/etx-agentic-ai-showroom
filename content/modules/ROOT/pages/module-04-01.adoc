...
3. Add the Llama Guard model to the Input and Output sheild form sections:
+
...
+
4. Test functionality by typing something or asking something harmful in the chat interface. Observe the model's behavior. Try a few different things and s
