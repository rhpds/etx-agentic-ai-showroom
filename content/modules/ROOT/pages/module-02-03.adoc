...
. **If you deployed locally** with the above command, revert your file edit and delete the token from your file to avoid any accidental token commits to GitHub. You will push changes in the next module.
...
. Edit the Llama Stack ConfigMap `llama-stack-config`.
